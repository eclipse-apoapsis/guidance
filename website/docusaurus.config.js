...
const config = {
  ...
  tagline: 'Open Source Management based on Open Source at scale',
  ...
  projectName: 'guidance', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Eclipse Apoapsis Contributors. Built with Docusaurus.`,
      },
      prism: {
